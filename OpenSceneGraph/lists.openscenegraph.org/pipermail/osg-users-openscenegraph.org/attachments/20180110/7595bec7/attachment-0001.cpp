...
void Renderer::updateSceneView(osgUtil::SceneView* sceneView)
{
    ...
    if (view)
    {
        ...
        switch(view->getLightingMode())
        {
            case(osg::View::NO_LIGHT): sceneView->setLightingMode(osgUtil::SceneView::NO_SCENEVIEW_LIGHT); break;
            case(osg::View::HEADLIGHT): sceneView->setLightingMode(osgUtil::SceneView::HEADLIGHT); break;
            case(osg::View::SKY_LIGHT): sceneView->setLightingMode(osgUtil::SceneView::SKY_LIGHT); break;
        }
    }
